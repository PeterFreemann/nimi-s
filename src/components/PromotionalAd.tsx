          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 h-[500px]">
            <div className="bg-gradient-to-br from-orange-500 to-red-500 p-8 text-white flex flex-col justify-center">
              <div className="mb-4">
                ...
                <p className="text-orange-100 text-lg animate-slideInLeft opacity-0" 
              ...
              <div className="flex items-center space-x-4 animate-slideInUp opacity-0" 
                ...
                <button 
                  ...
                  className="bg-white text-orange-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 hover:shadow-lg animate-bounce-subtle"
                >
                  Shop Now
                </button>
                <span className="text-orange-200 text-sm animate-blink">*Valid until end of month</span>
              </div>
            </div>
